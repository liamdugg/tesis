...
\ifthenelse{\equal{\LanguageOption}{portuguese}}{%
    ...
    \ifthenelse{\equal{\LanguageOption}{spanish}}{%
        ...
        \noindent Esta disertación es un trabajo original, elaborado exclusivamente para este fin, habiendo sido debidamente citados todos los autores cuyos estudios contribuyeron a su elaboración. Se permite su reproducción parcial indicando el autor y referencia al grado, año académico, institución - \textit{Politécnico de Leiria} - y fecha de defensa pública.
    }{%
        \noindent \textbf{\GetTitle}
