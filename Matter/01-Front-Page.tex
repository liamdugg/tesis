...
\begin{titlepage}
    ...
    \ifthenelse{\equal{\SchoolOption}{utnfrba}}{
        \begin{figure}
            \includegraphics[width=0.485\linewidth]{Figures/Theme/Logotypes/IPLeiria-UTNFRBA-Logo-B.pdf}
        \end{figure}
    }{}
    ...
    \hspace*{-2.5pt}\begin{tabular}{@{}l@{\hspace{5pt}}>{\raggedright\arraybackslash}m{6cm}@{}}
        ...
        \ifdefined\GetCoSupervisor
            \textbf{Docentes:} & \GetCoSupervisor \\ [-.7ex]
        ...
        \ifdefined\GetSecCoSupervisor        
            ...
            & \setstretch{0.9}{\fontsize{8}{10}\selectfont\itshape \GetSecCoSupervisorTitle} \\ [.5ex]
        \fi

        \ifdefined\GetThirdCoSupervisor        
            & \GetThirdCoSupervisor \\ [-.7ex]
            & \setstretch{0.9}{\fontsize{8}{10}\selectfont\itshape \GetThirdCoSupervisorTitle} \\
        \fi
    \end{tabular}
    }
