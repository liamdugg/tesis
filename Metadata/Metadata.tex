...
\CoSupervisorMail{sverrastro@frba.utn.edu.ar}
\CoSupervisorTitle{Docente de Proyecto Final, Universidad Tecnologica Nacional FRBA} 

% Second Co-Supervisor (Optional)
\SecCoSupervisor{Mg. Ing. Mariano Vidal}
\SecCoSupervisorMail{mvidal@frba.utn.edu.ar}
\SecCoSupervisorTitle{Ayudante de Proyecto Final, Universidad Tecnológica Nacional FRBA}

% Third Co-Supervisor (Optional)
% \ThirdCoSupervisor{Nombre del tercer co-supervisor}
% \ThirdCoSupervisorMail{correo@ejemplo.com}
% \ThirdCoSupervisorTitle{Cargo, Institución}
