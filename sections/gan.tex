\newpage
\section{Tecnología GaN HEMT} \label{sec:gan_hemt}
\subsection{Contexto y relevancia de la tecnología del transistor}
...
% ------------------------------------------------------------------------ %
\subsection{Principio de funcionamiento y características del transistor GaN HEMT}
...
% ------------------------------------------------------------------------ %
\subsection{Comparación con tecnologías LDMOS y GaAs}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{imgs/transistor_tech_comparison.png}
