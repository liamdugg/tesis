\newpage
\section{Solución Propuesta} \label{sec:solucion_propuesta}

\subsection{Redefinición del Alcance y Objetivos del Proyecto}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{imgs/pa_block_diagram.png}
    \caption{Diagrama en bloques de la topología propuesta para el amplificador de potencia.}
    \label{fig:diagrama_bloques}
\end{figure}

% -----------------------------------------------------------------------------------------------%
\subsection{Transistor Seleccionado}
...
% -----------------------------------------------------------------------------------------------%
\subsection{Metodología de Diseño y Simulación}
...
% -----------------------------------------------------------------------------------------------%
\subsection{Metodología de Diseño de PCB}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{imgs/pcb_stubs_extra.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{imgs/pcb_ltx_extra.png}
