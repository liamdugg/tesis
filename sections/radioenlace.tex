\subsection{Cálculo de Radioenlace Satelital} \label{sec:radioenlace}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{imgs/slant_range.png}
...
% ------------------------------------------------------------------------ %
\subsection{Implementación Computacional y Simulación}
