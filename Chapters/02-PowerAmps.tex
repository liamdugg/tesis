...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{Figures/pa_efficiency.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{Figures/rf_power.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{Figures/TwoPortNetworkScatteringAmplitudes.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.65\linewidth]{Figures/im_spectrum.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.65\linewidth]{Figures/load_pull_theory.png}
