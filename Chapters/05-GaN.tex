...
La ecuación~\eqref{eq:ron} muestra que, dado que el GaN posee un campo de ruptura considerablemente mayor que el del silicio, la resistencia de canal alcanzable para una misma tensión resulta menor, obteniendo así menores pérdidas de conducción y, por lo tanto, mayor eficiencia.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{Figures/05/gan_crossection.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\linewidth]{Figures/05/gan_fieldplate.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.65\linewidth]{Figures/05/tech_comparison.png}
...
En el Cuadro~\ref{tab:material_comparison} se resumen las propiedades físicas más relevantes de los materiales semiconductores considerados, a partir de los valores reportados en \cite{mishra2008}.
