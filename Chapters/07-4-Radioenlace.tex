...
\begin{figure}[H]
    ...
    \caption{Curva de $E_b/N_0$ disponible frente a elevación para una tasa de bits constante ($R_b = 3~\,Mbps$).}
...
\begin{figure}[H]
    ...
    \caption{Curvas diferenciadas de $E_b/N_0$ disponible por modulación para un ancho de banda fijo ($BW = 2~\,MHz$).}
