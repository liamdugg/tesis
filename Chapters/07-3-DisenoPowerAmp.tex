...
Bajo los mismos criterios de diseño considerados para el diseño del PCB del acoplador híbrido en cuadratura se diseño el PCB para el amplificador de potencia. El esquemático optimizado del amplificador, con los componentes reales y las redes de adaptación y de estabilidad ya definidas, se trasladó al entorno Altium Designer para el diseño del layout físico. La Figura~\ref{fig:pcb_3d_front} muestra una vista tridimensional del resultado de este proceso, en el cual cada componente conserva la referencia asignada en el esquemático de ADS.

\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{Figures/07/pcb_3d_front.png}
    \caption{Vista 3D de la cara superior del PCB del amplificador de potencia.}
    \label{fig:pcb_3d_front}
\end{figure}

Dado que el diseño correspondía a una primera versión de desarrollo, y considerando la disponibilidad limitada de únicamente dos unidades del transistor para la totalidad del proyecto, el layout se concibió con el objetivo de habilitar la mayor cantidad posible de mediciones y ajustes experimentales sobre la misma placa fabricada. Con este fin, se incorporaron pads adicionales sin conexión eléctrica que permiten, en caso de ser necesario, extender la longitud de los stubs de las redes de adaptación (Figura~\ref{fig:pcb_stub_ajustable}) o modificar el ancho de las líneas de transmisión (Figura~\ref{fig:pcb_txline_ajustable}) mediante la incorporación manual de puentes de soldadura, sin requerir una nueva iteración completa de fabricación de la placa.

\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{Figures/07/pcb_stubs_extra.png}
    ...
    \label{fig:pcb_stub_ajustable}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{Figures/07/pcb_ltx_extra.png}
    ...
    \label{fig:pcb_txline_ajustable}
\end{figure}
