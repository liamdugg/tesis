...
Si bien las magnitudes de los parámetros de transmisión resultan similares entre ambas versiones, la frecuencia central de la versión 2 se encuentra más próxima a los 2,2\,GHz de diseño que la de la versión 1, consistente con el corrimiento identificado durante la verificación electromagnética. De manera análoga, la diferencia de fase de la versión 2 a la frecuencia de interés resulta considerablemente más próxima al valor ideal de $90°$ que la de la versión 1.
