\chapter[Resultados, Mediciones y Verificación]{Resultados, Mediciones y Verificación} \label{sec:4_resmedver}

% -----------------------------------------------------------------------------------------------%
\section{Parámetros de Dispersión Medidos}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{Figures/s11_plot.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{Figures/s21_plot.png}
...
% -----------------------------------------------------------------------------------------------%
\section{Extracción del P1dB}
El punto de compresión de ganancia de 1\,dB (P1dB) constituye una figura de mérito clave para amplificadores de potencia, definido como el nivel de potencia de entrada en el cual la potencia de salida se desvía 1\,dB respecto de la respuesta lineal de pequeña señal extrapolada. Este punto delimita el límite de la región de operación lineal del amplificador~\cite{pozar2011}.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{Figures/p1db_plot.png}
...
% -----------------------------------------------------------------------------------------------%
\section{Ganancia, Eficiencia de Drain y Ancho de Banda}
...
% -----------------------------------------------------------------------------------------------%
\subsection{Eficiencia de Drain}
...
% -----------------------------------------------------------------------------------------------%
\section{Distorsión Armónica Medida}
...
Se obtuvo un OIP3 de 39,83\,dBm. Este valor resulta consistente con la relación experimental esperada entre el P1dB y el OIP3, donde el OIP3 suele ser de 10 a 15\,dB mayor que el P1dB~\cite{pozar2011}.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{Figures/oip3_plot.png}
